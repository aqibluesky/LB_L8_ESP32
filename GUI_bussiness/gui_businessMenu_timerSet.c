...
static void lvGui_bMenuSet_B_pageReaptSet_creat(uint8_t currentWeekHoldBit){
	...
	lv_obj_set_pos(objpage_reaptSet, 20, 30);					
	...
	stylePageCb_reaptSet.body.radius = 6;
	stylePageCb_reaptSet.body.opa = LV_OPA_90;
	stylePageCb_reaptSet.body.padding.hor = 0;
	stylePageCb_reaptSet.body.padding.inner = 0;	
	...
	stylePageBtn_reaptSet.text.color = LV_COLOR_BLACK;
